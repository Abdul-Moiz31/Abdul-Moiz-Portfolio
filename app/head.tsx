...
const Head = () => {
  ...
  const meta = {
    ...
    keywords: 'Abdul Moiz, Jeandv, Abdul Moiz portafolio, Jeandv portafolio, Jeandv portfolio, Abdul Moiz portfolio, Jeandv github, Abdul Moiz github, Jeandv LinkedIn, Abdul Moiz LinkedIn, Web, Desarrollo web, Programador web, Diseño web, Paginas web, Aplicaciones web, Aplicaciones móviles, Aplicaciones escritorio, Desarrollo frontend, Programador frontend, HTML, CSS, Javascript, Typescript, React, Angular.',
    type: 'website'
  };
