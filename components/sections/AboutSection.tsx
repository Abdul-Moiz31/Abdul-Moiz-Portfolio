    ...
    <SectionContainer>
      ...
      <div className='w-full flex flex-col gap-6'>
        ...
        <AnimationContainer customClassName='w-full flex flex-col gap-5 mb-8'>
          ...
          <p className='text-base text-gray-400'>
            Started with non-tech background then moving towards the no-code development. I started exploring programming about +5years ago. I have tried a few programming languages and technology stack, both Backend and Frontend.
          </p>

          <p className='text-base text-gray-400'>
            Event though the scope of web development is wide, I was very interested and focused on Frontend development in start but now love to work as a full stack Developer.
          </p>
